...
public:
    ...
    // parallel, per-utterance encoder/prompt/prefill stay serial, and the
    // text decoder decodes all utterances in lockstep through one shared
    // batched graph. Result[i] corresponds to requests[i].
