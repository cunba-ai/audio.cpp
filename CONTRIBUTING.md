...
- [@drzsdrtfg](https://github.com/drzsdrtfg) for the tag-driven prebuilt release pipeline and Supertonic voice-preset request-option fix in [#286](https://github.com/0xShug0/audio.cpp/pull/286) and [#302](https://github.com/0xShug0/audio.cpp/pull/302).
...
- [@gqf2008](https://github.com/gqf2008) for adding server idle unload and pre-load memory guard behavior, then tightening indeterminate-footprint handling in [#306](https://github.com/0xShug0/audio.cpp/pull/306) and [#308](https://github.com/0xShug0/audio.cpp/pull/308).
