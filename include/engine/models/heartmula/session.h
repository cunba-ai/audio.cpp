...
private:
    ...
    size_t generator_backbone_prefill_graph_arena_bytes_ = 64ull * 1024ull * 1024ull;
    size_t generator_backbone_step_graph_arena_bytes_ = 64ull * 1024ull * 1024ull;
    size_t generator_decoder_prefill_graph_arena_bytes_ = 64ull * 1024ull * 1024ull;
    size_t generator_decoder_step_graph_arena_bytes_ = 64ull * 1024ull * 1024ull;
    size_t generator_frame_embedding_graph_arena_bytes_ = 64ull * 1024ull * 1024ull;
    size_t codec_weight_context_bytes_ = 32ull * 1024ull * 1024ull;
    size_t codec_flow_estimator_graph_arena_bytes_ = 64ull * 1024ull * 1024ull;
    size_t codec_conditioning_graph_arena_bytes_ = 64ull * 1024ull * 1024ull;
    size_t codec_scalar_decoder_graph_arena_bytes_ = 64ull * 1024ull * 1024ull;
